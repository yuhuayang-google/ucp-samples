...
class GrpcService extends common_1.Service {
    ...
    getGrpcCredentials_(callback) {
        this.authClient.getClient().then(client => {
            const credentials = this.grpc.credentials.combineChannelCredentials(this.grpc.credentials.createSsl(), this.grpc.credentials.createFromGoogleCredential(client));
