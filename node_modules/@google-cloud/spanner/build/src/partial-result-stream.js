...
class PartialResultStream extends stream_1.Transform {
    ...
    _createRow(values) {
        const fields = values.map((value, index) => {
            ...
            const columnMetadata = (_a = this._options.columnsMetadata) === null || _a === void 0 ? void 0 : _a[name];
            return {
                name,
...
function partialResultStream(requestFn, options) {
    ...
    const timeout = (_b = (_a = options === null || options === void 0 ? void 0 : options.gaxOptions) === null || _a === void 0 ? void 0 : _a.timeout) !== null && _b !== void 0 ? _b : Infinity;
